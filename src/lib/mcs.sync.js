 ...
 * Oracle Mobile Cloud Service Sync JavaScript SDK, Release: 18.1.3.1, E93561-01
*/
...
(function (g) {
  ...
  function persistenceDB(name, $options) {
    ...
    // exec on DOM ready!
    if ($options.isCordova) {
      $options.deviceReady(function () { init(); });
    } else {
      $options.ready(init);
    }
  ...
  function persistenceXMLHttpRequestInstall(XHR, $sync, $utils, $options, $common, $handler, $events) {
    ...
    function SyncXMLHttpRequest() {
      ...
      // properties/methods that has different functionality depends on url
    ...
    SyncXMLHttpRequest.prototype.defake = function () {
      ...
      var methods = [
        //"abort",
        //"setRequestHeader",// overridden in constructor
        "send",
        //"addEventListener",// overridden in constructor
        "removeEventListener",
        "getResponseHeader",
        "getAllResponseHeaders",
        "dispatchEvent",
        //"overrideMimeType"// overridden in constructor
      ];
      ...
      var properties = [
        //"onabort",// overridden in constructor
        //"onerror",// overridden in constructor
        //"onload",// overridden in constructor
        "readyState",
        "responseText",
        "response",
        "responseType",
